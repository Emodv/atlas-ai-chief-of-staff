  ...
  return (
    <main style={{minHeight:'100vh',display:'grid',placeItems:'center',padding:'24px',background:'radial-gradient(circle at 50% 30%,rgba(129,80,255,.14),transparent 30%),#050710',color:'#fff',fontFamily:'Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif'}}>
      <section style={{width:'min(560px,100%)',textAlign:'center'}}>
        ...
        <p style={{fontSize:18,lineHeight:1.55,color:'#aeb4c7',margin:'0 auto 28px',maxWidth:480}}>Atlas.Moda could not complete Google authorization. Nothing was connected or changed. Retry when Google authorization is available.</p>
        <a href="/invite" style={{display:'flex',alignItems:'center',justifyContent:'center',textDecoration:'none',color:'#fff',fontSize:19,fontWeight:800,background:'linear-gradient(100deg,#b449ff,#685cff)',borderRadius:20,padding:'18px 22px',boxShadow:'0 14px 45px rgba(109,76,255,.22)'}}>Back to Atlas.Moda</a>
